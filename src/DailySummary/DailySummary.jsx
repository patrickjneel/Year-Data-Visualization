...
const DailySummary = ({ summaryData, selectedDateData, dailyRev, numProducts }) => {
  ...
  let dailyTotSum = Math.floor(Math.random() * (112 - 8 + 1)) + 8;
      ...
      return (
        <div className="daily-summary-container">
          ...
          <div className="bottom-card">
            ...
            <span className="numbers-shown products-right">Products Sold: <span className="daily-totals">{dailyTotSum}</span></span>
          </div>
        </div>
      )
}
